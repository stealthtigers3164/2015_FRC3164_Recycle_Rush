...
public class ToteFinder {
	private class ParticleReport implements Comparator<ParticleReport>,
	...
	private NIVision.Range TOTE_HUE_RANGE = new NIVision.Range(130, 180); // Default hue //100,140
																	// range for
																	// yellow
																	// tote
	private NIVision.Range TOTE_SAT_RANGE = new NIVision.Range(90, 255); // Default //20,225
																	// saturation
																	// range for
																	// yellow
																	// tote
	private NIVision.Range TOTE_VAL_RANGE = new NIVision.Range(90, 300); // Default //100,300
																	// value
																	// range for
																	// yellow
																	// tote
	...
	private double LONG_RATIO = 2.22; // Tote long side = 26.9 / Tote height = 12.1 =
								// 2.22
	private double SHORT_RATIO = 1.4; // Tote short side = 16.9 / Tote height = 12.1 =
								// 1.4
	private double SCORE_MIN = 50.0; // Minimum score to be considered a tote
	private double VIEW_ANGLE = 60; // View angle fo camera, set to Axis m1011 by
	...
	private NIVision.ParticleFilterOptions2 filterOptions = new NIVision.ParticleFilterOptions2(
			0, 0, 1, 1);
	private Scores scores = new Scores();
	private int session;

	public ToteFinder(ICallback cb) {
		// create images
